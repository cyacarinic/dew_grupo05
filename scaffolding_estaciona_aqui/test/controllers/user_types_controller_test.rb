...
class UserTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_type" do
    assert_difference('UserType.count') do
      post user_types_url, params: { user_type: { descripcion: @user_type.descripcion, nombre: @user_type.nombre } }
    end
  ...
  test "should update user_type" do
    patch user_type_url(@user_type), params: { user_type: { descripcion: @user_type.descripcion, nombre: @user_type.nombre } }
