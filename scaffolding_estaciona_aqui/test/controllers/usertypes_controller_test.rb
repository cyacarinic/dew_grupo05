...
class UsertypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usertype" do
    assert_difference('Usertype.count') do
      post usertypes_url, params: { usertype: { descripcion: @usertype.descripcion, nombre: @usertype.nombre } }
    end
  ...
  test "should update usertype" do
    patch usertype_url(@usertype), params: { usertype: { descripcion: @usertype.descripcion, nombre: @usertype.nombre } }
